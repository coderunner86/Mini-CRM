...
function jsonData($name, $city)
{
    $data_employee = array("first" => $name, "last" => $city);
            ...
            <div class="card card-body">
                <form action="save.php" method="POST">
                    <div class="form group">
                        <input type="text" name="name" class="form-control" placeholder="Employee name" autofocus>
                    ...
                    <input type="submit" onclick = "postData(url, data)" class="btn btn-success btn-block" name="save_employee" value="Save Employee">
                </form>
            </div>
        </div>
        <div class="col-md-8">
