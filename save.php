...
<?php include("includes/post_info.php") ?>
<?php
...
if (isset($_POST['save'])) {
    ...
    $query = "INSERT INTO employees(firstname, lastname, city, email, phone, description, id, id_remote) VALUES ('$firstname', '$lastname', '$city', '$email', '$phone', '$description', '$id_remote', '$id_remote')";
